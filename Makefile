...
.PHONY: all
all: practice cass_add_user cass_get_user cass_init cass_user.so
...
cass_get_user: cass_get_user.c util.c
	gcc $(CFLAGS) -o $@ $^ $(CASSFLAGS)
...
.PHONY: clean
clean:
	rm -f practice cass_add_user cass_get_user cass_init cass_user.so cass_user.o util.o
